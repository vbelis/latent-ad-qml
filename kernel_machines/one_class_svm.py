...
class CustomOneClassSVM(OneClassSVM):
    ...
    """
    def __init__(self, *, kernel='rbf', degree=3, gamma='scale', coef0=0, tol=0.001, nu=0.5, shrinking=True, cache_size=200, verbose=False, max_iter=-1):
        super().__init__(kernel=kernel, degree=degree, gamma=gamma, coef0=coef0, tol=tol, nu=nu, shrinking=shrinking, cache_size=cache_size, verbose=verbose, max_iter=max_iter)
