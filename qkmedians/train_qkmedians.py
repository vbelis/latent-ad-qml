...
if __name__ == "__main__":
    ...
    parser.add_argument('-device_name', dest='device_name',type=str, help='name of GPU, if using')

    args = parser.parse_args()
    
    if args.device_name: qibo.set_device(args.device_name)
    
    train_qkmedians(args.latent_dim, args.train_size, args.read_file, args.device_name, args.seed, args.k, args.tolerance, args.save_dir)
